...
### Model inputs
The interface allows the user to select basic characteristics of the virus and population (strain, R_eff). The level of pre-existing infection-induced immunity is then set using age-specific input sliders defining the proportion previously infected with SARS-CoV-2 for each age group.
