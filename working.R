...
# #ok
 ...
 asdf <- if(FALSE){setNames(list(a,b),c('a1','b2'))}else{
...
fs(x = if(FALSE){setNames(list(a,b),c('a1','b2'))}else{
  setNames(list(b,a),c('a1','b2'))})
